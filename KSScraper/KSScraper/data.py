...
def get_pages(limit = 1):
    ...
    pages.append(requests.get('https://www.kickstarter.com/projects/1715039846/a-juice-bar-rebuilt-by-its-backers'))
    pages.append(requests.get('https://www.kickstarter.com/projects/1779651746/afro-yo-a-new-concept-for-self-serve-frozen-yogurt'))
